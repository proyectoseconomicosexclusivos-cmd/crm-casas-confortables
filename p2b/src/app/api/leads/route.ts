...
export const GET = withAuth(async (req: NextRequest, session: any) => {
  ...
  // Filtro por empresa/oficina/equipo según rol
...
export const POST = withAuth(async (req: NextRequest, session: any) => {
  ...
  if (!firstName || !lastName || !phone) {
    return errorResponse('Nombre, apellidos y teléfono son requeridos');
  }
  ...
  // Crear notificación si está asignado a alguien más
