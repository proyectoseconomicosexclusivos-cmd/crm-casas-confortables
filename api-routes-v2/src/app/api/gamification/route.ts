...
// GET /api/gamification - Obtener ranking y estadisticas
export const GET = withAuth(async (req: NextRequest, session: any) => {
  ...
  // Obtener usuarios con sus estadisticas
...
export const POST = withAuth(async (req: NextRequest, session: any) => {
  ...
  // Verificar si ha desbloqueado algun logro
